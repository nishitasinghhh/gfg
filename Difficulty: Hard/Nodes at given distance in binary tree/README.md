...
<ul>
<li><span style="font-size: 18px;">You can return the answer in any order, but the final output will always be displayed in sorted order by the driver code.</span></li>
